...
import { ensureBrokerSession, loadBrokerSession } from "./broker-lifecycle-stub.mjs";
...
class SpawnedCodexAppServerClient extends AppServerClientBase {
  ...
  async initialize() {
    // Allow test injection via BUDDY_BROKER_CODEX_BIN (points to a stub script).
    const codexBin = (this.options.env ?? process.env).BUDDY_BROKER_CODEX_BIN;
    const [cmd, cmdArgs] = codexBin
